...
from app.routers import auth, projects, specs, files, agents, chat, subscription, status
...
# app.include_router(marketplace.router, prefix="/api/marketplace", tags=["Marketplace"])  # Disabled for now
